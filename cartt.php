...
<?php
    if (isset($_SESSION['loggedin'])) {echo'
            ...
            <div class="col-lg-8">
                ...
                <div class="text-center pt-4">
                    <button type="button" class="btn btn-warning btn-lg" style="justify-content: center;">Place Order <img src="img/lightning-bolt-thunder-lighting-strike-expertise-flat-vector-icon-apps-websites-155180575.jpg" alt=""></button>
                </div>
            </div>';}else{
                echo'<div class="m-5 fs-1 text-center">Login to </br><b>Cycle Shopee </b></br>to see items in your Cart</div>';
            }
