...
<head>
    ...
    <title>Cycle Shopee - Orders</title>
</head>
...
<body>
    ...
    <div class="container padding-bottom-3x mb-0">
        <h2><img src="img/orders-icon.png" width="30">&nbsp;&nbsp;Your Orders </h2>
        <div class="row">
            <div class="col-lg-3">
            ...
            <?php
                if (isset($_SESSION['loggedin'])) {
                    ...
                    $getprno="SELECT * from `$tblacusr` where Target = 'o'";
                    ...
                    while($row=mysqli_fetch_assoc($res)){
                        ...
                        <a href="orderht.php?cancel='.$row1['id'].'" class="btn btn-warning">Cancel Order</a>&nbsp;&nbsp;&nbsp;
                        </div>
                        </div>
                        </div>';
                    }
