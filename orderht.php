                        ...
                        <div class="col-md-4 mb-5">
                            ...
                            <div class="">
                                ...
                                <div class="text-center pt-4">
                                    ...
                                    <button type="button" class="btn btn-success btn-sm mr-1 mb-2">Add to Cart</button>
                                    <button type="button" class="btn btn-info btn-sm mr-1 mb-2">Details</button>
                                    <button type="button" class="btn btn-elegant btn-sm px-3 mb-2 material-tooltip-main" data-toggle="tooltip" data-placement="top" title="Remove from wishlist">Add to wishlist</button>
